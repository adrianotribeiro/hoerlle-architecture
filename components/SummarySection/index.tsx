      ...
      <div className="flex h-[50vh] w-full flex-col justify-center bg-[url('/images/residencial_summary.png')] bg-100% bg-no-repeat md:h-[45.6vh] md:bg-[url('/images/bg_06.png')] md:bg-contain md:bg-no-repeat xl:h-[60vh] xl:bg-[url('/images/residencial_summary.png')] xl:bg-25% xl:bg-repeat-x 2sm:h-[38vh] 6xl:h-[40vh]">
        <div className="flex flex-col gap-3 4xl:gap-6">
          <div className="flex flex-col items-center gap-1">
            <p className="font-montserrat text-3xl font-light text-[#ffffff] md:text-[40px] xl:text-6xl">Residencial</p>
            <hr className="w-[50%] border-b-[0.5px] border-[#ffffff] md:w-[35%] xl:w-[32%] 4xl:w-[28%] 5xl:w-[20%] 6xl:w-[25%]" />
          </div>
          <p className="hidden font-montserrat font-light text-[#ffffff] md:m-auto md:flex md:text-center md:text-4xl xl:w-[75%] xl:px-0 xl:text-5xl 2sm:px-4 5xl:w-[60%]">
            Mauris vitae risus urna. Phasellus placerat sit amet nulla non lobortis. Pellentesque sed interdum enim.
          </p>
          <p className="px-2 text-center font-montserrat text-3xl font-light text-[#ffffff] md:hidden xl:m-auto xl:w-[85%] xl:text-center xl:text-5xl 5xl:w-[60%]">
