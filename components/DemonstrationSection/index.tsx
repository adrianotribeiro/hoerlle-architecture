        ...
        <div className="pt-3 xl:flex xl:w-full xl:gap-2 xl:px-6 xl:pt-0 4xl:px-6 5xl:px-12">
          <div className="flex flex-col items-center gap-2 md:flex-row md:flex-wrap md:justify-center xl:gap-3">
            ...
            <Image
              ...
              alt=""
              className="md:w-[709px] lg:w-[828px] xl:h-fit xl:w-[568px] 3xl:h-[258px] 3xl:w-[610px] 4xl:h-[297px] 4xl:w-[612px] 4_xl:h-[325px] 4_xl:w-[662px] 5xl:h-[463px] 5xl:w-[852px] 6xl:h-[355px] 6xl:w-[667px]"
            />
          </div>
        </div>
      </div>
